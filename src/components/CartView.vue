  ...
  <div class="cart-container">
    ...
    <div v-if="showOrderCode" class="order-modal">
      <div class="order-modal-content">
        ...
        <p class="order-info">
          Покажите этот код при получении заказа в нашем магазине.
          <br>г.Курск, пр-кт. Кулакова, Д-1-В
          <br>Оплата производится при получении.
          
        </p>
        <h3>Вашь заказ и код отобразяться в профиле</h3>
